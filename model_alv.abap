...
PUBLIC SECTION.
  ...
  TYPES:
    BEGIN OF ty_out,
      ...
      " VL COMISS�O REPROCESSADO
      " % COMISS�O REPROCESSADO
...
*          lo_sorts->add_sort('TRKORR') .
  ...
  METHOD search.
    " TODO: parameter COMPENSACAO is never used (ABAP cleaner)
    " TODO: parameter ZSDT017 is never cleared or assigned (ABAP cleaner)
    " TODO: parameter J_1BNFDOC is never cleared or assigned (ABAP cleaner)
    " TODO: parameter J_1BNFLIN is never cleared or assigned (ABAP cleaner)
